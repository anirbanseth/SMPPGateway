...
namespace SMSGateway.DataManager.General
{
    ...
    /// </summary>
    public class MySqlDataConnection : IDisposable
    {
        #region FIELDS
        private static string sConnStr = string.Empty;
        internal MySqlConnection oConn = null;

        internal MySqlTransaction oTran = null;
        #endregion
        ...
        public MySqlDataConnection(string connStr)
        {
            //sConnStr = WebConfigurationManager.ConnectionStrings["connectionString"].ConnectionString;
            sConnStr = connStr;
        }
